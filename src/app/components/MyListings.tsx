              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="rounded-lg p-2 text-center" style={{ background: '#F7F6F2' }}>
                    <p style={{ fontSize: 14, fontWeight: 500, color: '#444441' }}>{listing.qty.toLocaleString()}{listing.unit}</p>
                    <p style={{ fontSize: 10, color: '#5F5E5A' }}>Available</p>
                  </div>
                  <div className="rounded-lg p-2 text-center" style={{ background: '#F7F6F2' }}>
                    <p style={{ fontSize: 14, fontWeight: 500, color: '#444441' }}>{listing.sold.toLocaleString()}{listing.unit}</p>
